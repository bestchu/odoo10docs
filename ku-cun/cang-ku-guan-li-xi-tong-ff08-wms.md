...
为使用此功能，需要通过“仓库→配置→设置”，在“产品”一节的“产品变体”字段，点选“ 产品可以有好几个属性，通过不同属性来定义不同的产品变体 ”。
...
![](file:///C:\Users\ADMINI~1\AppData\Local\Temp\ksohtml\wpsEB4F.tmp.png)

属性的类型会影响在网站商店中产品属性的选择方式。属性类型为“点选”时的效果，如下图：

![](file:///C:\Users\ADMINI~1\AppData\Local\Temp\ksohtml\wpsEB50.tmp.png)

属性类型为“下拉框”时的效果，如下图：

![](file:///C:\Users\ADMINI~1\AppData\Local\Temp\ksohtml\wpsEB51.tmp.png)

属性类型为“颜色”时，其效果如下：

![](file:///C:\Users\ADMINI~1\AppData\Local\Temp\ksohtml\wpsEB61.tmp.png)

属性录入完毕后，你需要通过“仓库→配置→产品→属性值”来录入各属性可能的属性值。

![](file:///C:\Users\ADMINI~1\AppData\Local\Temp\ksohtml\wpsEB62.tmp.png)

对于属性类型为颜色的属性值，请为属性值输入“HTML颜色索引”。

最后你可以在产品窗体的“产品属性”选项卡中点击“添加一个项目”来选择产品的属性和属性值。注意每个属性至少要选择两个值，否则这个属性会被忽略。

![](file:///C:\Users\ADMINI~1\AppData\Local\Temp\ksohtml\wpsEB63.tmp.png)

保存后，你可以点击产品窗体左上角的“属性价格”按钮，并为各属性和属性值进行定义和编辑，并可以附加价格属性。

![](file:///C:\Users\ADMINI~1\AppData\Local\Temp\ksohtml\wpsEB64.tmp.png)

在上例中，最终的产品就是语言和打印类型的组合。根据属性的组合，此产品的价格也会随着附加属性价格发生变化，你可以通过菜单“仓库→库存管理→产品属性”来查看它们。

![](file:///C:\Users\ADMINI~1\AppData\Local\Temp\ksohtml\wpsEB65.tmp.png)
